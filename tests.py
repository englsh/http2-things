...
NEED TO ADD:
    ...
    ADD SSL TO ALLOW FOR HTTPS BECAUSE HALF THE WEBSITES REJECT HTTP THESE DAYS
    ADD MORE VALIDATION TO SETTINGS FRAME WHEN I CAN BE BOTHERED

WANT TO ADD
    UNIVERSAL FRAME CLASS THAT CAN ACT AS SUPER CLASS FOR THINGS SUCH AS SETTINGS FRAMES 
'''
